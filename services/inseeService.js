// Service layer for future API providers. The current implementation targets INSEE and falls back to mock content when unavailable.
class InseeService {
...
const inseeService = new InseeService();
